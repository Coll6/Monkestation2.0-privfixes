...
/datum/preference/choiced/backpack/init_possible_values()
	return list(
		...
		LSATCHEL,
		GDUFFELBAG,
		BSATCHEL, //MONKESTATION EDIT
		RSATCHEL, //MONKESTATION EDIT
		DBACKPACK,
		DSATCHEL,
		DDUFFELBAG,
	)
...
/datum/preference/choiced/backpack/icon_for(value)
	switch (value)
		...
		if (BSATCHEL)
			return /obj/item/storage/backpack/satchel/blackleather //MONKESTATION EDIT
		if (RSATCHEL)
			return /obj/item/storage/backpack/satchel/retro //MONKESTATION EDIT
