...
/obj/machinery/limbgrower
	...
	var/list/categories = list(SPECIES_HUMAN, SPECIES_ARACHNIDS, SPECIES_ETHEREAL, SPECIES_LIZARD, SPECIES_MOTH, SPECIES_PLASMAMAN, RND_CATEGORY_LIMBS_OTHER,) // Monkestation Edit:
