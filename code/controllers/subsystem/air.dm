...
/datum/controller/subsystem/air/proc/add_to_expansion(a, b)


/datum/controller/subsystem/air/proc/remove_from_expansion(a, b)
...
/datum/controller/subsystem/air/proc/expand_pipeline(a, b)
