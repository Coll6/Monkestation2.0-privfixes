...
/*
	...
	var/list/avian_wings_list
	var/list/avian_wingsopen_list
	var/list/ears_list_avian
...
/datum/controller/subsystem/accessories/proc/setup_lists()
	...
	//avian_wings_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/arm_wings)[DEFAULT_SPRITE_LIST]
	//avian_wingsopen_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/arm_wingsopen)[DEFAULT_SPRITE_LIST]
	//ears_list_avian = init_sprite_accessory_subtypes(/datum/sprite_accessory/plumage)[DEFAULT_SPRITE_LIST]
	...
	//ears_list_goblin = init_sprite_accessory_subtypes(/datum/sprite_accessory/goblin_ears)[DEFAULT_SPRITE_LIST]
	...
	//ipc_antennae_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/ipc_antennas)[DEFAULT_SPRITE_LIST]
	//ipc_screens_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/ipc_screens)[DEFAULT_SPRITE_LIST]
	//ipc_chasis_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/ipc_chassis)[DEFAULT_SPRITE_LIST]
