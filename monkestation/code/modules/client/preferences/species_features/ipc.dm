...
/datum/preference/choiced/ipc_chassis/icon_for(value)
	var/datum/sprite_accessory/sprite_accessory = GLOB.ipc_chassis_list[value]

	var/icon/final_icon = icon('monkestation/icons/mob/species/ipc/bodyparts.dmi', "blank")
	var/icon/chassis_icon = icon('monkestation/icons/mob/species/ipc/ipc_chassis.dmi', "m_ipc_chassis_[sprite_accessory.icon_state]_FRONT")
